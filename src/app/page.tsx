            ...
            <div className="demo-screen rounded-3xl p-1 shadow-2xl">
              <div className="bg-white rounded-3xl p-8">
                <div className="flex flex-col lg:flex-row gap-6">
                  {/* PDF Viewer Mockup */}
                  <div className="lg:w-1/2 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 shadow-inner border border-gray-200">
                    <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-300">
                      ...
                      <span className="text-xs text-gray-500 bg-gray-200 px-2 py-1 rounded">Page 1 of 15</span>
                    </div>
                    <div className="space-y-2.5">
                      <div className="h-2.5 bg-gray-300 rounded w-full"></div>
                      <div className="h-2.5 bg-gray-300 rounded w-5/6"></div>
                      <div className="h-2.5 bg-purple-300 rounded w-4/6"></div>
                      <div className="h-2.5 bg-gray-300 rounded w-full"></div>
                      <div className="h-2.5 bg-gray-300 rounded w-3/4"></div>
                      <div className="h-10 bg-gray-200 rounded my-3 border-2 border-dashed border-gray-300"></div>
                      <div className="h-2.5 bg-gray-300 rounded w-full"></div>
                      <div className="h-2.5 bg-purple-300 rounded w-5/6"></div>
                      <div className="h-2.5 bg-gray-300 rounded w-2/3"></div>
                    </div>
                  </div>

                  {/* Chat Interface Mockup */}
                  <div className="lg:w-1/2 bg-white rounded-2xl p-6 shadow-inner border border-gray-200">
                    ...
                    <div className="space-y-4 h-56 overflow-y-auto mb-4">
                      ...
                      <div className="flex justify-start">
                        <div className="chat-bubble-ai text-gray-700 px-4 py-2.5 rounded-2xl text-sm max-w-xs shadow-md">
                          Based on <span className="font-semibold text-purple-600">[Page 3]</span>, the main hypothesis is that machine learning algorithms can significantly improve prediction accuracy...
                        </div>
                      </div>
                      <div className="flex justify-end">
                        <div className="chat-bubble-user text-white px-4 py-2.5 rounded-2xl text-sm max-w-xs shadow-md">
